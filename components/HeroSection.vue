        ...
        <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
          <div class="flex">
            <div class="relative flex items-center gap-x-4 rounded-full px-4 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              <span class="font-semibold text-indigo-600">iOS アプリ</span>
              <span class="h-4 w-px bg-gray-900/10" aria-hidden="true" />
              <a href="https://apps.apple.com/jp/app/添加物スキャナー/id6469045264" class="flex items-center gap-x-1">
          ...
          <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">食品添加物と上手に付き合うために</h1>
          <p class="mt-6 text-lg leading-8 text-gray-600">添加物スキャナーはどんな食品添加物が使われているか簡単に調べられるアプリです。食品の添加物ラベルを読み取り、その内容をAI技術を活用して自動的に認識し、分析結果を表示します。</p>
          <div class="mt-10 flex items-center gap-x-6">
            <a href="#" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">添加物スキャナー for iOS</a>
        ...
        <div class="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
          <svg viewBox="0 0 366 729" role="img" class="mx-auto w-[22.875rem] max-w-full drop-shadow-xl">
            ...
            <foreignObject width="316" height="684" transform="translate(24 24)" clip-path="url(#2ade4387-9c63-4fc4-b754-10e687a0d332)">
              <img src="https://firebasestorage.googleapis.com/v0/b/food-additive-7acb1.appspot.com/o/public%2FIMG_7380.PNG?alt=media&token=8df0cdc7-ea83-4446-b009-c35fde07ecd7" alt="" />
            </foreignObject>
          </svg>
        </div>
      </div>
