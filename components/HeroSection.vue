      ...
      <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
        <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
          ...
          <div class="mt-10 flex items-center gap-x-6">
            <PrimariButton href="https://apps.apple.com/jp/app/添加物スキャナー/id6469045264">添加物スキャナー for iOS</PrimariButton>
          </div>
        </div>
...
import PrimariButton from '@takasqr/tw-vue-ui/template/primary-button/PrimaryButton.vue'
